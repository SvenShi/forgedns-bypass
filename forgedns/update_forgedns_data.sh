...
# 设置代理地址、账号和密码
PROXY="http://172.16.2.40:7890"

# 临时目录
TMPDIR=$(mktemp -d) || exit 1
TARGET_DIR="/opt/forgedns/dat"
...
v2dat unpack geoip -o $TARGET_DIR -f telegram -f cn "$TMPDIR/geoip.dat"
echo "Unpacking geosite.dat..."
v2dat unpack geosite -o $TARGET_DIR -f cn -f private -f apple -f apple-cn -f geolocation-!cn -f category-games@cn "$TMPDIR/geosite.dat"
